...
$categoria = 'recepcao'; // Define a categoria desta página
...
<head>
    ...
    <title>Galeria de Recepção - Estância Ilha da Madeira</title>
    ...
    <section class="min-h-screen px-4 md:px-8 py-16">
        <div class="max-w-7xl mx-auto">
            <div class="flex items-center space-x-4 mb-8">
                ...
                <h1 class="text-3xl md:text-4xl font-normal text-rosa-vibrante">Galeria de Recepção</h1>
            </div>
